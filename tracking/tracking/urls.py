...
urlpatterns = [
    ...
    path('main_page/states/<int:state_id>/change_compound', change_compound_projects_to_state,
         name="compound_state"),
    ...
    path('main_page/priorities/<int:priority_id>/change_compound', change_compound_projects_to_priority,
